...
class pageReportSubEx extends StatefulWidget {
  ...
  final List<RevenueSubCategoryReportData> reportList;
  ...
  pageReportSubEx(this.stateDate, this.endDate, this.reportList, this.ListTotal,
      this.listCureency, this.iexpen,this.namecat);

  @override
  _pageReportSubEx createState() => new _pageReportSubEx();
}

class _pageReportSubEx extends State<pageReportSubEx>
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Text(widget.namecat,textAlign: TextAlign.center,style: TextStyle(fontWeight: FontWeight.bold,
                                            fontSize: 20),),
                                          ),
                                          decoration: BoxDecoration(
                                            borderRadius:
                                                  ...
                                                  children: <Widget>[
                                                    Container(
                                                        ...
                                                        child: Padding(
                                                          padding:
                                                          EdgeInsets.all(5),
                                                          child: Text(AppLocalizations().lbFrom +
                                                              widget.stateDate
                                                                  .toString()),
                                                        )),
                                                    new Spacer(),
                                                    Container(
                                                        ...
                                                        child: Padding(
                                                          padding:
                                                          EdgeInsets.all(5),
                                                          child: Text(AppLocalizations().lbTo +
                                                              widget.endDate),
                                                        ))
                                                  ],
                                                ),
              ...
              Directionality(
                ...
                child:
                                                ...
                                                Padding(
                                                 ...
                                                 Row(children: <Widget>[   Text(AppLocalizations().lbMove+' : '+widget
                                                     .ListTotal[0].number
                                                     .toString(),
                                                   textDirection: langSave=='ar'?TextDirection.rtl:TextDirection.ltr,)],)
                                                     ,
                                                      Padding(padding:EdgeInsets.fromLTRB(0, 12, 0, 5),child:
                                                      Row(children: <Widget>[
                                                        Text(AppLocalizations().lbExTotal+' : '+widget
                                                            .ListTotal[0].total
                                                            .toString() +
                                                            ' ( ' +
                                                     ...
                                                     Row(children: <Widget>[ Text(AppLocalizations().lbDebt+' : '+widget
                                                         .ListTotal[0].debt
                                                         .toString() +
                                                         ' ( ' +
                                                         widget.listCureency[0]
                                      ...
                                      Padding(padding: EdgeInsets.fromLTRB(10, 15, 10, 15),
                                        child: Container(
                                          ...
                                          child: _getBodyWidget(widget.reportList),
                                        ),)
                                    ],
                                  ),
                                ),
  ...
  Widget _generateFirstColumnRow(BuildContext context, int index) {
    return Container(
      child: Text(widget.reportList[index].date.toString().substring(0,10)
      ),
      width: 75,
      height: 52,
  ...
  Widget _generateRightHandSideColumnRow(BuildContext context, int index) {
    return Row(
      children: <Widget>[
        Container(
          child: Text(widget.reportList[index].description),
        ...
        Container(
          child: Text(widget.reportList[index].value),
          width: 75,
          height: 52,
        ...
        Container(
          child: Text(widget.reportList[index].amount),
          width: 75,
          height: 52,
          padding: EdgeInsets.fromLTRB(5, 0, 0, 0),
          alignment: Alignment.centerLeft,
        ...
        Container(
          child: Text(widget.reportList[index].rest),
          width: 75,
          height: 52,
          padding: EdgeInsets.fromLTRB(5, 0, 0, 0),
          alignment: Alignment.centerLeft,
        ...
        Container(
          child: Text(widget.reportList[index].payment),
          width: 75,
          height: 52,
          padding: EdgeInsets.fromLTRB(5, 0, 0, 0),
          alignment: Alignment.centerLeft,
        ...
        Container(
          child: widget.reportList[index].image!=null?Text(widget.reportList[index].image):Text(""),
          width: 75,
          height: 52,
          padding: EdgeInsets.fromLTRB(5, 0, 0, 0),
          alignment: Alignment.centerLeft,
        ...
        Container(
          child: widget.reportList[index].customer!=null?Text(widget.reportList[index].customer):Text("")
         ,
          width: 75,
          height: 52,
          padding: EdgeInsets.fromLTRB(5, 0, 0, 0),
  ...
  Widget _getBodyWidget(List<RevenueSubCategoryReportData> reportModel) {
    return Container(
  ...
  List<Widget> _getTitleWidget() {
    return [
      _getTitleItemWidget(AppLocalizations().lbDate, 75),
      _getTitleItemWidget(AppLocalizations().lbDes, 80),
      _getTitleItemWidget(AppLocalizations().lbTotal, 75),
      _getTitleItemWidget(AppLocalizations().lbVal, 75),
      _getTitleItemWidget(AppLocalizations().lbrest, 75),
      _getTitleItemWidget(AppLocalizations().lbPayment, 75),
      _getTitleItemWidget(AppLocalizations().lbImage, 75),
      _getTitleItemWidget(AppLocalizations().lbCus, 75),
    ];
  }
