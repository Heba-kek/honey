...
import 'package:honey/presentation/page/pageReportMain.dart';
import 'package:honey/presentation/page/pageReportSubEx.dart';
...
class reportSubCateExpen extends StatefulWidget {
  final String iExpen;
  final String subId;
  final String mainName;
  final String mainId;
final dateFormat,dateFormatAR;
  reportSubCateExpen(this.iExpen,this.subId,this.mainName,this.mainId,this.dateFormat,this.dateFormatAR);

  @override
  _reportSubCateExpen createState() => new _reportSubCateExpen();
}

class _reportSubCateExpen extends State<reportSubCateExpen>
    with WidgetsBindingObserver {


  List<RevenueSubCategoryReportData> reportListCateSub;

  List<Total> ListTotalCateSub;
  List<Currency> listCureencyCateSub;
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        body: BlocProvider(
            ...
            child: signinViewReportCate()));
  }




  Widget signinViewReportCate() {
    return BlocConsumer<ExpBloc, ExpState>(listener: (context, state) {
      if (state is ExpensesSubCategoryReportLoaded) {
        print('Success');
        print(state.expensesSubCategoryReportEntity.data);
        reportListCateSub = state.expensesSubCategoryReportEntity.data;
        ListTotalCateSub = state.expensesSubCategoryReportEntity.total;
        listCureencyCateSub = state.expensesSubCategoryReportEntity.currency;
            ...
            pageBuilder: (_, __, ___) =>
                ...
                Directionality(
                  textDirection: langSave ==
                      ...
                      .ltr,
                  child:
                pageReportSubEx(dateF,dateT,reportListCateSub,ListTotalCateSub,listCureencyCateSub,widget.iExpen,widget.mainName),
          )),
        );
...
//                          dateOnly: true,
                                                    ...
                                                    GestureDetector(
                                                      ...
                                                      Center(child: Container(child: Padding(padding:EdgeInsets.fromLTRB(30,10,30,10)
                                                          ,child:Text(AppLocalizations().lbSend)),decoration:  BoxDecoration(
                                                        borderRadius:
                                                        BorderRadius
                                                            .circular(
                                                            15.0),
                                                      ...
                                                      if (monVal == true) {
                                                        if (todate.currentState
                                                          ...
                                                          context.bloc<ExpBloc>().add(ExpensesSubCategoryReportEvent(
                                                              int.parse(widget.mainId),"",dateT,  int.parse(widget.subId)));
                                                        ...
                                                        if (fromdate.currentState
                                                          ...
                                                          context.bloc<ExpBloc>().add(ExpensesSubCategoryReportEvent(
                                                              int.parse(widget.mainId),dateF,dateT,  int.parse(widget.subId)));
