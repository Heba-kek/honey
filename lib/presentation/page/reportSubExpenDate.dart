...
class reportSubCateExpen extends StatefulWidget {
  ...
  reportSubCateExpen(this.iExpen, this.subId, this.mainName, this.mainId,
      this.dateFormat, this.dateFormatAR);
...
//                          dateOnly: true,
                                                                      ...
                                                                      decoration:
                                                                          InputDecoration(
                                                                              labelText: AppLocalizations().lbFDate),
                                                    ...
                                                    onTap: () {
                                                      if (monVal == true) {
                                                        if (todate.currentState
                                                          ...
                                                          context
                                                              .bloc<ExpBloc>()
                                                              .add(ExpensesSubCategoryReportEvent(
                                                                  int.parse(widget
                                                                      .mainId),
                                                                  "",
                                                                  dateT,
...
//          primary: false,
        ...
        print('Error');
        print(state.message);
        Toast.show(state.message, context, duration: 4, gravity: Toast.BOTTOM);
