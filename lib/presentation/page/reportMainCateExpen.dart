...
class reportMainCateExpen extends StatefulWidget {
  ...
  final List<RevenueReportData> reportList;

  final List<Total> ListTotal;
  final List<Currency> listCureency;
  final String iExpen;

  reportMainCateExpen(this.stateDate, this.endDate, this.reportList,
      this.ListTotal, this.listCureency,this.iExpen);

  @override
  _reportMainCateExpen createState() => new _reportMainCateExpen();
}

class _reportMainCateExpen extends State<reportMainCateExpen>
                                          ...
                                          return new Padding(
                                            ...
                                            child: GestureDetector(
                                              child: Padding(
                                                        ...
                                                        index].category!=null?    Padding(
                                                            ...
                                                            child: Row(
                                                              children: <
                                                                ...
                                                                Text(widget
                                                                    .reportList[
                                                                index].category),new Spacer(),Text(widget
                                                                    .reportList[
                                                                index]
                                                                    .total)
                                                              ],
                                                ...
                                                backgroundColor:
                                                Colors.black26, //background progressbar color
                                              ),
                                            )
                                                            ), new Spacer(),
                                                            Padding(
                                                ...
                                                Navigator.of(context).push(
                                                    ...
                                                    Directionality(
                                                        textDirection: langSave ==
                                                            ...
                                                            .ltr,
                                                        child:
                                                        reportMainCate(widget.iExpen, widget
                                                            .reportList[
                                                        index].categoryId
                                                            , widget
                                                                .reportList[
                                                            index].category,dateFormat,dateFormatAR))));
                                              },
                                            ),
                                          );
                                        },
