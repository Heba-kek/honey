...
class _expensiveSubCatPage extends State<expensiveSubCatPage>
                                          ...
                                          children: <Widget>[
                                            ...
                                            Container(
                                              ...
                                              child: ListView.builder(
                                                itemCount: expListSub.length,shrinkWrap: false,
                                                                              ...
                                                                              if (value == 2) {
                                                                                showDialog(
                                                                                    ...
                                                                                    builder: (BuildContext context) {
                                                                                      return showDialogwindowDelete(expListSub[index].sub_category_id);
                                                                                    });
                                                                              } else if (value == 3) {
                                                                                showDialog(
                                                                                    context: context,
                                                                                    builder: (BuildContext context) {
                                                                                      return showDialogwindowEdit(expListSub[index].sub_category_id);
                                                                                    });
                                                                              }
                                                                            },
                                                                          ))
  ...
  Widget showDialogwindowDelete(String catid) {
    return AlertDialog(
      ...
      content: Text('Are you confirm delete this sub category ?'),
      actions: <Widget>[
